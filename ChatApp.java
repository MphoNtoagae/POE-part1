...
class Message {
    ...
    public void displayMessage() {
        System.out.println("From: " + Mpho_);
        System.out.println("To: " + Katt_);
...
public class ChatApp {
    ...
    static void createAccount() {
        System.out.print("Enter username: Mpho_ ");
        String username = scanner.nextLine();

        System.out.print("Enter password: Yanka007_ ");
        String password = scanner.nextLine();

        System.out.print("Enter South African phone number (+27719841057): ");
        String phoneNumber = scanner.nextLine();

        if (!phoneNumber.matches("\\+27\\719841057")) {
            System.out.println("valid SA phone number format.");
            return;
        }
    ...
    static void sendMessage() {
        System.out.print("Enter sender username: Mpho_ ");
        String sender = scanner.nextLine();

        System.out.print("Enter receiver username: Katt_ ");
        String receiver = scanner.nextLine();

        if (!userExists(sender) || !userExists(receiver)) {
            System.out.println("Sender or receiver does exist");
            return;
        }

        System.out.print("Enter message: Hi ");
        String payload = scanner.nextLine();

        messages.add(new Message(sender, receiver, payload));
        System.out.println("Message sent successfully!");
    }

    static void viewMessages() {
        System.out.print("Enter your username to view messages: Mpho_ ");
        String username = scanner.nextLine();
